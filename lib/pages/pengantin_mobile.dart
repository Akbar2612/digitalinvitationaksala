...
class PengantinMobile extends StatefulWidget {
  ...
  @override
  State<PengantinMobile> createState() => _PengantinMobileState();
}

class _PengantinMobileState extends State<PengantinMobile>
  ...
  Widget _buildLoveIcon() {
    return SlideTransition(
      ...
      child: FadeTransition(
        ...
        child: Icon(Icons.favorite, color: Color(0xFFD4AF37), size: 28),
      ),
    );
  }
